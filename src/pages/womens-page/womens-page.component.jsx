...
import "./womens-page.styles.scss";
...
const WomensPage = ( { collection  }) => {
    ...
    const {title , items } = !!collection ? collection : SHOP_DATA.womens;

    const womens = <div className="collection-page">
    ...
    const data = loading ? <Spinner/> : womens;
    return (
        <>{data}</>
    )
